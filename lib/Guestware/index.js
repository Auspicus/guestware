 ...
 * @param {Number} timeout       timeout in ms (default 120 seconds)
 * @constructor
 */
function Guestware(wsdl, appName, versionNumber, username, password, appID, timeout) {
  this.wsdl = wsdl;
    ...
    '<soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">',
      '<soap:Header>',
        this.appID ? '<' + this.appID + ' xmlns="http://webservices.guestware.com/">' : '',
          ...
          '<VersionNumber>' + this.versionNumber + '</VersionNumber>',
