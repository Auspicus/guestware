...
var ReadGuestLoginGuestIDStringRequest = /** @class */ (function (_super) {
    __extends(ReadGuestLoginGuestIDStringRequest, _super);
    function ReadGuestLoginGuestIDStringRequest(email) {
    ...
    return ReadGuestLoginGuestIDStringRequest;
}(SoapRequest_1["default"]));
exports["default"] = ReadGuestLoginGuestIDStringRequest;
