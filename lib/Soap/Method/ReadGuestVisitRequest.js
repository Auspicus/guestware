...
var ReadGuestVisitRequest = /** @class */ (function (_super) {
    __extends(ReadGuestVisitRequest, _super);
    function ReadGuestVisitRequest(guestID, locationID) {
        var _this = this;
        var parstrLocationId = locationID ? "<web:parstrLocationId>" + locationID + "</web:parstrLocationId>" : '';
    ...
    return ReadGuestVisitRequest;
}(SoapRequest_1["default"]));
exports["default"] = ReadGuestVisitRequest;
