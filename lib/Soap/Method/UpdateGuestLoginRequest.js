...
var UpdateGuestLoginRequest = /** @class */ (function (_super) {
    __extends(UpdateGuestLoginRequest, _super);
    function UpdateGuestLoginRequest(dataset) {
    ...
    return UpdateGuestLoginRequest;
}(SoapRequest_1["default"]));
exports["default"] = UpdateGuestLoginRequest;
