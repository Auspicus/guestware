...
var ReadGuestLoginRequest = /** @class */ (function (_super) {
    __extends(ReadGuestLoginRequest, _super);
    function ReadGuestLoginRequest(id) {
    ...
    return ReadGuestLoginRequest;
}(SoapRequest_1["default"]));
exports["default"] = ReadGuestLoginRequest;
