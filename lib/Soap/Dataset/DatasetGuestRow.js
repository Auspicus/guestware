...
var DatasetGuestRow = /** @class */ (function () {
    ...
    DatasetGuestRow.prototype.serialize = function (rowId) {
        ...
        var includeInBefore = (this.diff === DiffgramRowAction_1["default"].Modified
            || this.diff === DiffgramRowAction_1["default"].Deleted);
        var includeInCurrent = this.diff !== DiffgramRowAction_1["default"].Deleted;
        var diffgrHasChanges = this.diff === DiffgramRowAction_1["default"].NotSet
            ? ""
